...
from .views import  VisitViewset , QuestionViewset , KindOfCounselingViewset ,VisitConsultationsViewset ,VisitConsultationsDetialViewset ,CardBoxUserViewSet ,CardBoxConsultantViewset
urlpatterns = [
